...
<div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2500">
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <div class="hero" style="background-image: url('images/mi.jpg');">
                <div class="container">
        ...
        <div class="carousel-item">
            <div class="hero" style="background-image: url('images/xiamoi.png');">
                <div class="container">
    ...
    <h2 class="text-white text-center" style="margin-bottom: 40px;">Xiaomi Series</h2>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/siomai6a.png') }}" class="card-img-top" alt="Handphone 1" >
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">MI 12</h5>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/siomaiultra.png') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">MI ULTRA</h5>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/14.png') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">MI 14 T</h5>
                    <p class="card-text text-white">Deskripsi singkat tentang handphone 2.</p>
                    <div class="mt-auto">
                        <a href="#" class="btn btn-success">Buy Now</a>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/REDMI14.png') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">REDMI NOTE 14+</h5>
                    <p class="card-text text-white">Deskripsi singkat tentang handphone 2.</p>
                    <div class="mt-auto">
                        <a href="#" class="btn btn-success">Buy Now</a>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/poco.png') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">POCO X6 PRO</h5>
                    <p class="card-text text-white">Deskripsi singkat tentang handphone 2.</p>
                    <div class="mt-auto">
                        <a href="#" class="btn btn-success">Buy Now</a>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/redminote14.webp') }}" class="card-img-top" alt="Handphone 3">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">REDMI NOTE 14</h5>
