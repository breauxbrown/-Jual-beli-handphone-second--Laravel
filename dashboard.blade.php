...
<div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2500">
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <div class="hero" style="background-image: url('images/16pro.jpg');">
                <div class="container">
        ...
        <div class="carousel-item">
            <div class="hero" style="background-image: url('images/arul.jpg');">
                <div class="container">
        ...
        <!-- Slide 2 -->
        <div class="carousel-item">
            <div class="hero" style="background-image: url('images/vi.webp');">
                <div class="container">
        ...
        <!-- Slide 3 -->
        <div class="carousel-item">
            <div class="hero" style="background-image: url('images/is.jpg');">
                <div class="container">
    ...
    <h2 class="text-white text-center" style="margin-bottom: 40px;">Produk Terbaru</h2>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/200.png') }}" class="card-img-top" alt="Handphone 1" >
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">Vivo X200</h5>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                ...
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">Handphone 2</h5>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/24.webp') }}" class="card-img-top" alt="Handphone 3">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">Handphone 3</h5>
...
<div class="container">
  ...
  <div class="row gy-4">
    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
      ...
      <img src="{{ asset('images/ipong.jpg') }}" class="img-fluid rounded-4 mb-4" alt="">
    ...
    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
      <div class="content ps-0 ps-lg-5">
        ...
        <div class="position-relative mt-4">
          <img src="{{ asset('images/xiamoi.png') }}" class="img-fluid rounded-4" alt="">
