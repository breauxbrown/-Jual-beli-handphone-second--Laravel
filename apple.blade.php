...
<div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2500">
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <div class="hero" style="background-image: url('images/ipong.jpg');">
                <div class="container">
         ...
         <div class="carousel-item">
            <div class="hero" style="background-image: url('images/mac.jpg');">
                <div class="container">
         ...
         <!-- Slide 2 -->
         <div class="carousel-item">
            <div class="hero" style="background-image: url('images/relax.webp');">
                <div class="container">
          ...
          <!-- Slide 2 -->
          <div class="carousel-item">
            <div class="hero" style="background-image: url('images/dua.jpg');">
                <div class="container">
    ...
    <h2 class="text-white text-center" style="margin-bottom: 40px;">IPHONE SERIES</h2>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/ip16.webp') }}" class="card-img-top" alt="Handphone 1" >
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">IPHONE 16 HIJAU MINT</h5>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/ip16promax.webp') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">IPHONE 16 PROMAX DESERT TITANIUM</h5>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/ip13blue.png') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">IPHONE 13 MINI BLUE</h5>
                    <p class="card-text text-white">Deskripsi singkat tentang handphone 2.</p>
                    <div class="mt-auto">
                        <a href="#" class="btn btn-success">Buy Now</a>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/ipucok.png') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">IPHONE X SILVER</h5>
                    <p class="card-text text-white">Deskripsi singkat tentang handphone 2.</p>
                    <div class="mt-auto">
                        <a href="#" class="btn btn-success">Buy Now</a>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/ip11white.png') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">IPHONE 11 WHITE</h5>
                    <p class="card-text text-white">Deskripsi singkat tentang handphone 2.</p>
                    <div class="mt-auto">
                        <a href="#" class="btn btn-success">Buy Now</a>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/ip15pink.png') }}" class="card-img-top" alt="Handphone 3">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">IPHONE 15 PINK</h5>
