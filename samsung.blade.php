...
<div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2500">
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <div class="hero" style="background-image: url('images/smsng.jpg');">
                <div class="container">
        ...
        <div class="carousel-item">
            <div class="hero" style="background-image: url('images/galaxy.jpg');">
                <div class="container">
    ...
    <h2 class="text-white text-center" style="margin-bottom: 40px;">SAMSUNG SERIES</h2>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/sung.AVIF') }}" class="card-img-top" alt="Handphone 1" >
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">SAMSUNG S25 ULTRA</h5>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/fold.AVIF') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">SAMSUNG Z FOLD 6</h5>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/s23.WEBP') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">SAMSUNG S23+</h5>
                    <p class="card-text text-white">Deskripsi singkat tentang handphone 2.</p>
                    <div class="mt-auto">
                        <a href="#" class="btn btn-success">Buy Now</a>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/hpnods.png') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">SAMSUNG S9+</h5>
                    <p class="card-text text-white">Deskripsi singkat tentang handphone 2.</p>
                    <div class="mt-auto">
                        <a href="#" class="btn btn-success">Buy Now</a>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/alima.AVIF') }}" class="card-img-top" alt="Handphone 2">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">SAMASUNG A55 5G</h5>
                    <p class="card-text text-white">Deskripsi singkat tentang handphone 2.</p>
                    <div class="mt-auto">
                        <a href="#" class="btn btn-success">Buy Now</a>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-12 mb-3 d-flex">
            <div class="card border-light bg-dark h-100 w-100" style="border-radius: 20px;">
                <img src="{{ asset('images/s22.WEBP') }}" class="card-img-top" alt="Handphone 3">
                <div class="card-body d-flex flex-column text-center">
                    <h5 class="card-title text-white">SAMSUNG S22 ULTRA</h5>
